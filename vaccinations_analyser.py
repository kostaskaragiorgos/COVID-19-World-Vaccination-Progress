...
def userinputvalidation(userinput="", colomnname="", continentf=False):
    """vadidates the user's input
    Args:
        userinput: the user input
        colomnname: the name of the dataset's column
    Returns:
        input flag: boolean value if the column contains the user input 
...
class Vaccinations_Analyser():
    def __init__(self,master):
        ...
        self.plot_menu.add_command(label="Vaccination Process of A Continent", accelerator='Alt+Y', command=lambda: self.plotvaccpross(userinputtitle="Continent", userinputprompt="Enter the name of the continent", x="date", ylabel="Number of Total Vaccinations"))
        ...
        self.master.bind('<Control-y>', lambda event: self.plotvaccpross(userinputtitle="Country", userinputprompt="Enter the name of the country", x="date",  ylabel="Number of Total Vaccinations"))
        self.master.bind('<Alt-y>', lambda event: self.plotvaccpross(userinputtitle="Continent", userinputprompt="Enter the name of the continent", x="date", ylabel="Number of Total Vaccinations"))
